  ...
  return (
    ...
    <ThemeProvider attribute='class'>
      <div className='grid grid-cols-12 gap-8 px-5 lg:px-48 my-14 sm:px-24 md:px-32 overflow-hidden '>
        ...
        <div className='lg:col-span-9 my-7 bg-gray-800 dark:bg-gradient-to-r from-gray-200 to-orange-200 rounded-3xl col-span-12 overflow-hidden shadow-md shadow-black'>
          <Navbar />
          <Component {...pageProps} />
        </div>
      </div>
