  ...
  return (
    <div>
        ...
        <div className='my-5 py-4 bg-gray-200 font-poppins' style={{marginLeft:'-1rem', marginRight:'-1rem'}}>
            ...
            <p>sinemark1@gmail.com</p>
        </div>
        {/* Email button*/}
        <div className='font-poppins'>
        <button className='bg-gradient-to-r from-cyan-200 to-purple-300 w-9/12 rounded-full py-2 px-5 my-2 focus:outline-none' onClick={()=>window.open('mailto:sinemark1@gmail.com')}>Contact Me</button>
        <button className='bg-gradient-to-r from-cyan-200 to-purple-300 w-9/12 rounded-full py-2 px-5 my-2'>Theme</button>
